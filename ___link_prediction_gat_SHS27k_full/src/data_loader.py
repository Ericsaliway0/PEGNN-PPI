...
def load_graph_data(file_path, dim):
    ...
    for node in G_nx.nodes():
        if 'embedding' in G_nx.nodes[node]:
            ...
            node_features.append([0] * dim)  # Assuming embedding size is 128
...
def load_graph_data_init(file_path, dimension):
    # Load data from JSON file
    with open(file_path, 'r') as file:
        data = json.load(file)
    ...
    for node in G_nx.nodes():
        if 'embedding' in G_nx.nodes[node]:
            ...
            # Handle missing 'embedding' (use zero vector or other default value)
            node_features.append([0] * dimension) 
...
def load_graph_data_ori(file_path):
    # Load data from JSON file
    with open(file_path, 'r') as file:
        data = json.load(file)
...
def load_graph_data_neo4j(file_path):
    # Load data from JSON file
    with open(file_path, 'r') as file:
        data = json.load(file)
...
def load_graph_data_initial(file_path):
    # Load data from JSON file
    with open(file_path, 'r') as file:
        data = json.load(file)
    ...
    for node in G_nx.nodes():
        if 'embedding' in G_nx.nodes[node]:
            ...
            # Handle missing 'embedding' (use zero vector or other default value)
            node_features.append([0] * 256)  # Assuming embedding size is 128
